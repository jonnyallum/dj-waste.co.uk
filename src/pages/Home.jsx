...
const Home = () => {
  ...
  return (
    <div className="bg-black text-white">
      ...
      {/* Google Reviews QR Code Section */}
      <section className="py-16 bg-gray-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-gradient-to-r from-gray-800 to-gray-900 rounded-2xl p-8 md:p-12">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
              <div>
                <h2 className="text-3xl md:text-4xl font-bold mb-4">
                  Love Our Service? <span className="text-blue-400">Leave a Review!</span>
                </h2>
                <p className="text-xl text-gray-300 mb-6">
                  Your feedback helps us improve and helps others find reliable waste and demolition services. 
                  Scan the QR code or click below to leave a Google review.
                </p>
                <div className="flex items-center space-x-2 mb-4">
                  ...
                  <Star className="h-5 w-5 text-yellow-400 fill-yellow-400" />
                  <Star className="h-5 w-5 text-yellow-400 fill-yellow-400" />
                  <span className="text-gray-300 ml-2">9.93/10 on Checkatrade</span>
                </div>
              ...
              <div className="flex justify-center">
                <div className="bg-white p-6 rounded-xl shadow-2xl">
                  ...
                  />
                  <p className="text-center text-gray-800 font-semibold mt-4">Scan to Review</p>
                </div>
              </div>
            </div>
          </div>
