        ...
        >
          ...
          >
            <a href="tel:07920449132">
              <Button
                size="lg"
                className="bg-[#00D4FF] hover:bg-[#00D4FF]/90 text-black text-lg px-8 py-6 glow-blue pulse-glow"
              >
        ...
        >
          {services.map((service, index) => (
            <motion.div key={index} variants={scaleIn}>
              <Card className="glass-card p-6 h-full group hover:border-[#00D4FF]/30 transition-all duration-300 hover:-translate-y-2">
                <div className="w-14 h-14 rounded-xl bg-gradient-to-br from-[#00D4FF]/20 to-[#00D4FF]/20 flex items-center justify-center mb-5 group-hover:scale-110 transition-transform">
          ...
          >
            ...
            <motion.div variants={fadeInUp} className="mt-8 flex flex-wrap gap-4">
              ...
              >
                <Button
                  size="lg"
                  className="bg-[#00D4FF] hover:bg-[#00D4FF]/90 text-white glow-blue-hover"
                >
                  <Phone className="w-5 h-5 mr-2" />
                  Get Free Quote
                </Button>
        ...
        >
          ...
          >
            <a href="tel:07920449132">
              <Button
                size="lg"
                className="bg-[#00D4FF] hover:bg-[#00D4FF]/90 text-black text-lg px-8 py-7 glow-blue pulse-glow"
              >
            ...
            >
              <Button
                size="lg"
                className="bg-[#25D366] hover:bg-[#25D366]/90 text-white text-lg px-8 py-7"
              >
            ...
            >
              <Button
                size="lg"
                variant="outline"
                className="border-[#00D4FF]/50 text-[#00D4FF] hover:bg-[#00D4FF]/10 text-lg px-8 py-7"
              >
